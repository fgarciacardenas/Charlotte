...
int main(int argc, char **argv) {
    ...
    while (ros::ok()) {  
        ...
        //cout << endl << control.buttons[0] << endl;
        //cout << endl << control.buttons[1] << endl;
        //cout << pos.posb(0) << endl;
        //cout << control.axes[0]*speed << endl;
        //cout << pos.posb(0) + control.axes[0]*speed << endl;
        //cout << endl << control.axes[3] << endl;
        ...
        vector<double> rosxd;
		rosxd.resize(xd.size());
		VectorXd::Map(&rosxd[0], xd.size()) = xd;
